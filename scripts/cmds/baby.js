...
if (args[0] === "teach") {
  ...
  onChat: async function ({ api, event, message, usersData }) {
    ...
    try {
      ...
      const simpleTriggers = ["baby","bot","bby","বেবি","বট","toru","hridoy","jan"];
      ...
      if (simpleTriggers.includes(raw)) {
        ...
        const replies = [
          ...
          "𝐀𝐬𝐬𝐚𝐥𝐚𝐦𝐮 𝐰𝐚𝐥𝐚𝐢𝐤𝐮𝐦 ♥",
          "মদ না খেলে হবেনা ভালো ছেলে 🚶",
          "𝐁𝐨𝐥𝐨 𝐤𝐢 𝐤𝐨𝐫𝐭𝐞 𝐩𝐚𝐫𝐢 𝐭𝐨𝐦𝐫 𝐣𝐨𝐧𝐧𝐨 🐸",
          "𝐋𝐞𝐛𝐮 𝐤𝐡𝐚𝐰 𝐝𝐚𝐤𝐭𝐞 𝐝𝐚𝐤𝐭𝐞 𝐭𝐨 𝐡𝐚𝐩𝐚𝐲 𝐠𝐞𝐬𝐨 ☺️🍋",
          "𝐆𝐚𝐧𝐣𝐚 𝐤𝐡𝐚 𝐦𝐚𝐧𝐮𝐬𝐡 𝐡𝐨 🍁",
          "──‎ 𝐇𝐮𝐌..? 👉👈",
          "কি হলো, মিস টিস করচ্ছো নাকি 🤣",
          "𝐁𝐢𝐬𝐬𝐚𝐬 𝐤𝐨𝐫𝐞𝐧 𝐑𝐚𝐬𝐞𝐥 𝐯𝐚𝐢 𝐚𝐦𝐢 𝐧𝐢𝐫𝐝𝐨𝐬𝐡 😥",
          "𝗖𝗛𝗜𝗡 𝗧𝗔𝗣𝗔𝗞 𝗗𝗔𝗠 𝗗𝗔𝗠✨"
        ];
